	...
	productForm.submit(function(event){
			...
			$.ajax({
				...
				success: function(data){
					...
					if (data.added){
						submitSpan.html("En la canasta <button type='submit' class='btn btn-link'>Remover?</button>")
					} else {
						submitSpan.html("<button type='submit'  class='btn btn-success btnTarjeta'>Comprar</button>")
					 }
